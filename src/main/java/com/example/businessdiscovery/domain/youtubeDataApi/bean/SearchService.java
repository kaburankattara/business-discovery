...
import com.example.businessdiscovery.domain.youtubeDataApi.SearchResults;
...
public class SearchService {
     ...
     */
    public SearchResults main(String searchKeyword) {
...
//            search.setType(type);
            ...
            if (searchResultList == null) {
                return SearchResults.createEmptyInstance();
            }

            SearchResults.prettyPrint(NUMBER_OF_VIDEOS_RETURNED, searchResultList.iterator(), queryTerm);
            return SearchResults.createInstanceBySearchResultIteratorList(searchResultList);
